...
class LoginUserForm(AuthenticationForm):
    ...
    def confirm_login_allowed(self, user):
        if user.username.startswith("s"):
           raise forms.ValidationError("Kullanıcı adında sistemimizde yasak olan bir karakter mevcuttur.Lütfen bu şartı sağlayan bir kullanıcı adı ile tekrar deneyiniz.")
